...
export interface TinyHyperGraphSolverOptions {
  ...
  SELECTIVE_RERIP_PORT_CONFLICT_COST?: number
...
export const applyTinyHyperGraphSolverOptions = (
  ...
  if (options.SELECTIVE_RERIP_PORT_CONFLICT_COST !== undefined) {
    solver.SELECTIVE_RERIP_PORT_CONFLICT_COST =
      options.SELECTIVE_RERIP_PORT_CONFLICT_COST
  }
...
export const getTinyHyperGraphSolverOptions = (
  ...
  SELECTIVE_RERIP_PORT_CONFLICT_COST:
    solver.SELECTIVE_RERIP_PORT_CONFLICT_COST,
...
export class TinyHyperGraphSolver extends BaseSolver {
  ...
  SELECTIVE_RERIP_PORT_CONFLICT_COST = 1
